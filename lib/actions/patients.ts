...
// Uygulama artık sadece e-Klinik (belge arşivi) özelliğini sunuyor — yatılı
// hasta takibi (durum/taburcu/vefat/vital/ameliyat) kaldırıldı. Her hasta
// kaydı doğrudan bu amaç için açılıyor; ayrı bir "kayıt türü" seçimi yok.
