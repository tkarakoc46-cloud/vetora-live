    ...
    <div className="max-w-2xl mx-auto p-5">
      <div className="card p-4 mb-5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-bold px-2 py-1 rounded-full bg-surface2">
      ...
      <div className="text-xs font-bold text-text3 uppercase mb-2">Hasta Günlüğü</div>
      <OwnerLiveFeed token={params.token} initialRecords={withSignedUrls as any} />

      <div className="text-xs font-bold text-text3 uppercase mb-2">Hastaneye Mesaj</div>
      <div className="card p-4 mb-3 bg-green-50 text-xs text-green">
        Gönderdiğiniz mesajlar otomatik olarak hastanenin WhatsApp hattına iletilir.
      </div>
      <div className="card p-3 space-y-2 mb-3 max-h-80 overflow-y-auto">
        {(messages ?? []).map((m) => (
